...
const Listener = () => {
    ...
    const [detailSongIndex, setDetailSongIndex] = useState(0);
            ...
            <View style={{
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Text
                                style={{color: "#333"}}>{loadSongsStatus ? songsData[currentSongIndex].title : null}</Text>
                            <Text
                ...
                <Modal
                    title={songsData[detailSongIndex] ? songsData[detailSongIndex].title : ''}
                    transparent
                    ...
                    <View style={{paddingVertical: 20}}>
                        <Text
                            style={{textAlign: 'center'}}>歌手：{songsData[detailSongIndex] ? songsData[detailSongIndex].artist : ''}</Text>
                        <Text
                            style={{textAlign: 'center'}}>时长：{songsData[detailSongIndex] ? songsData[detailSongIndex].duration : ''}</Text>
                    </View>
